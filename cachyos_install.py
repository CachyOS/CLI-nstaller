...
cachyos_packages = "linux-cachyos linux-cachyos-headers cachyos-settings paru cachyos-v3-mirrorlist cachyos-mirrorlist cachyos-fish-config yay nano git wget linux-headers linux "
